function [softmax_h, hid2softData] = hid2softForward(h_t, params, model, srcHidVecs, mask, isPredictPos)
%%%
%
...
%%%  
  ...
  if params.attnFunc>0 % attention mechanism
    ...
    [attnVecs, hid2softData.alignWeights] = attnLayerForward(model.W_a, h_t, srcHidVecs, mask);
