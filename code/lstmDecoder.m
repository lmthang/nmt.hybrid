  ...
  for tt=1:srcMaxLen % time
    ...
    for mm=1:numModels % model
      for ll=1:models{mm}.params.numLayers % layer
        ...
        % lstm cell
        [lstm{mm}{ll}] = lstmLayerForward(W{mm}{ll}, x_t, h_t_1, c_t_1, models{mm}.params, 1); % ll, tt, srcMaxLen, 
        h_t = lstm{mm}{ll}.h_t;
        ...
        if tt==srcMaxLen && ll==models{mm}.params.numLayers
          modelData{mm}.curMask = curMask;
          if models{mm}.params.attnFunc
            [h2sInfo] = attnLayerForward(h_t, models{mm}.params, models{mm}, modelData{mm}, tgtPos); 
  ...
  for sentPos = 1 : (maxLen-1)
    ...
    for mm=1:numModels % model
      for ll = 1 : models{mm}.params.numLayers
        ...
        [beamStates{mm}{ll}] = lstmLayerForward(W{mm}, x_t, h_t_1, c_t_1, models{mm}.params, 1); %  ll, srcMaxLen+sentPos, srcMaxLen
