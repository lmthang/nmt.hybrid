...
%           end
          ...
          % round positions
          trainData.positions = curPosOutput; %floor(positions) + params.zeroPosId; % those that correspond to nullIndices will be ignored in hid2softLayerForward, params.zeroPosId*ones(1, params.curBatchSize); %
